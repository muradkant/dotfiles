...
-- Treat Swash like a temporary screenshot overlay. True compositor fullscreen
-- puts it above layer-shell panels such as Noctalia; the launch wrapper records
-- and restores any fullscreen window that it temporarily displaces.
hl.window_rule({
    name = "swash-overlay",
    match = { class = "^(dev\\.lemmy\\.swash)$" },
    float = true,
    fullscreen_state = 2,
    sync_fullscreen = true,
    move = { "0", "0" },
